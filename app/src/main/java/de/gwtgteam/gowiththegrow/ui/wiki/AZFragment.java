...
public class AZFragment extends FragmentActivity implements AdapterView.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        intent.setClass(this.getApplicationContext(), DetailActivity.class);
